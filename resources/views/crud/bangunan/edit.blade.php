...
<div class="card mb-3">
    <div class="card-header">
        <a href="{{ route('bangunan') }}"><i class="fas fa-arrow-left"></i> Back</a>
    </div>
    <div class="card-body">

        <form action="{{ route('updateBangunan', $editBangunan->building_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
